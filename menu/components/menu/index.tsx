        ...
        <List> 
            ...
            <Link href="/product-type">
              <ListItemButton
                  ...
                  <ListItemText primary='Tipo de Pratos' sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </Link>
            <Link href="/product">
              <ListItemButton
                  ...
                  <ListItemText primary='Pratos' sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </Link>
        </List>
        <Divider />
        <List>
            <ListItem key='WhatsAppIcon' disablePadding sx={{ display: 'block' }}>
              <Link href="/whatsapp">
                <ListItemButton
                    sx={{
                        minHeight: 48,
