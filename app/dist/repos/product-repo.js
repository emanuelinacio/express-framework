...
const product_orm_1 = __importDefault(require("./orm/product-orm"));
/**
 * Get one user.
 *
 * @param id
...
function getOne(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const getOneQuery = product_orm_1.default.getOneProduct(id);
        if (getOneQuery !== null) {
            return getOneQuery;
        }
        return null;
...
function getAll() {
    return __awaiter(this, void 0, void 0, function* () {
        const getAll = yield product_orm_1.default.getAllProduct();
        if (getAll !== null) {
            return getAll;
        }
        return null;
