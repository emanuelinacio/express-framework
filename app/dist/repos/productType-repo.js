...
const productType_orm_1 = __importDefault(require("./orm/productType-orm"));
/**
 * Get one user.
 *
 * @param id
...
function getOne(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const getOneQuery = productType_orm_1.default.getOneProductType(id);
        if (getOneQuery !== null) {
            return getOneQuery;
        }
        return null;
...
function getAll() {
    return __awaiter(this, void 0, void 0, function* () {
        const getAll = yield productType_orm_1.default.getAllProductType();
        if (getAll !== null) {
            return getAll;
        }
        return null;
