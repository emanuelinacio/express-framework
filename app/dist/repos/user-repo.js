...
const users_orm_1 = __importDefault(require("./orm/users-orm"));
/**
 * Get one user.
 *
 * @param id
...
function getOne(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const getUsersQuery = yield users_orm_1.default.getOneUser(1);
        if (getUsersQuery) {
...
function getOneByEmail(email) {
    return __awaiter(this, void 0, void 0, function* () {
        const getUsersQuery = yield users_orm_1.default.getUserByEmail(email);
        if (getUsersQuery) {
            return getUsersQuery;
        }
        return null;
...
function getAll() {
    return __awaiter(this, void 0, void 0, function* () {
        const allUsers = yield users_orm_1.default.getAllUsers();
        if (allUsers !== null) {
            return allUsers;
        }
        return null;
