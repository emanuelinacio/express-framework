...
const productType_service_1 = __importDefault(require("@services/productType-service"));
...
router.get(exports.p.get, (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productType = yield productType_service_1.default.getAll();
...
router.post(exports.p.add, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Fetch data
    yield productType_service_1.default.addOne(user);
...
router.put(exports.p.update, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Fetch data
    yield productType_service_1.default.updateOne(user);
...
router.delete(exports.p.delete, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Fetch data
    yield productType_service_1.default.delete(Number(id));
    return res.status(OK).end();
}));
// Export default
